...
> API 설계, 개발, 테스트 및 배포 중 보안을 유지하기 위해 수행해야 하는 가장 중요한 작업의 **포괄적이고 실용적인 체크리스트**입니다.
...
이 프로젝트는 개발자가 API를 안전하게 설계, 개발 및 배포할 수 있도록 도와주는 API 보안을 위한 **포괄적이고 실용적인 체크리스트**입니다.

### ✨ 기능

- 🔒 **포괄적 커버리지**: 인증부터 CI/CD까지 API 보안의 모든 측면을 포함합니다
- 📝 **실용적이고 사용 가능**: 각 항목에는 설명과 실용적인 예제가 포함되어 있습니다
- 🎯 **잘 구성됨**: 보안 도메인별로 분류되어 있습니다
- 🔄 **지속적으로 업데이트**: 최신 표준 및 모범 사례를 따릅니다
- 🌍 **다국어 지원**: 페르시아어, 영어, 아랍어, 스페인어, 프랑스어, 독일어, 중국어, 일본어, 러시아어, 포르투갈어, 이탈리아어, 터키어, 힌디어 및 한국어로 제공됩니다
...
1. 이 저장소에 별표를 표시하여 최신 정보를 받으세요
2. 각 배포 전에 체크리스트를 검토하세요
3. 프로젝트와 관련된 항목을 확인하세요
4. 필요시 Pull Request를 제출하세요
...
이 프로젝트가 유용했다면 다음 방법으로 저희를 지원할 수 있습니다:
...
이 저장소를 쉽게 포크하고, 원하는 변경 사항을 적용하고, pull request를 제출할 수 있습니다.

질문이 있으시면 `info@zahedalfak.ir`로 이메일을 보내주세요.
...
[GitHub의 API 보안 체크리스트](https://github.com/MrAlfak/API-Security-Checklist)
...
이 섹션은 API 보안 체크리스트를 다양한 언어로 번역하는 진행 상황을 추적합니다.

### ✅ 완료된 번역
- [x] 🇮🇷 페르시아어 (فارسی) - `Readme.md`
- [x] 🇬🇧 영어 - `README.en.md`
- [x] 🇸🇦 아랍어 (العربية) - `README.ar.md`
- [x] 🇪🇸 스페인어 - `README.es.md`
- [x] 🇫🇷 프랑스어 - `README.fr.md`
- [x] 🇩🇪 독일어 - `README.de.md`
- [x] 🇨🇳 중국어 (간체) - `README.zh-cn.md`
- [x] 🇯🇵 일본어 - `README.ja.md`
- [x] 🇷🇺 러시아어 - `README.ru.md`
- [x] 🇵🇹 포르투갈어 - `README.pt.md`
- [x] 🇮🇹 이탈리아어 - `README.it.md`
- [x] 🇹🇷 터키어 - `README.tr.md`
- [x] 🇮🇳 힌디어 - `README.hi.md`
- [x] 🇰🇷 한국어 - `README.ko.md`
