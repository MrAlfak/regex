...
> **Eine umfassende und praktische Checkliste** der wichtigsten Aufgaben, die ausgeführt werden müssen, um die Sicherheit während des API-Designs, der Entwicklung, des Testens und der Bereitstellung zu gewährleisten.
...
- 🇩🇪 [Deutsch (German)](./README.de.md) - Aktuell
...
Dieses Projekt ist eine **umfassende und praktische Checkliste** für API-Sicherheit, die Entwicklern hilft, ihre APIs sicher zu entwerfen, zu entwickeln und bereitzustellen.

### ✨ Funktionen

- 🔒 **Umfassende Abdeckung**: Umfasst alle Aspekte der API-Sicherheit von der Authentifizierung bis zum CI/CD
- 📝 **Praktisch und Nutzbar**: Jeder Punkt enthält Erklärungen und praktische Beispiele
- 🎯 **Gut Organisiert**: Nach Sicherheitsdomänen kategorisiert
- 🔄 **Kontinuierlich Aktualisiert**: Hält Schritt mit den neuesten Standards und Best Practices
- 🌍 **Mehrsprachige Unterstützung**: Verfügbar in Persisch, Englisch, Arabisch, Spanisch, Französisch und Deutsch

### 🎯 Für Wen?

- Backend-Entwickler, die APIs erstellen
- DevOps- und Sicherheitsteams
- Software-Architekten und Technical Leads
- Studenten und Sicherheitsenthusiasten

### 🚀 Schnellstart

1. Markieren Sie dieses Repository mit einem Stern, um auf dem Laufenden zu bleiben
2. Überprüfen Sie die Checkliste vor jeder Bereitstellung
3. Markieren Sie die für Ihr Projekt relevanten Punkte
4. Senden Sie bei Bedarf einen Pull Request
...
Wenn Ihnen dieses Projekt nützlich war, können Sie uns auf folgende Weise unterstützen:
...
Sie können dieses Repository einfach forken, Ihre gewünschten Änderungen anwenden und einen Pull Request einreichen.

Wenn Sie Fragen haben, senden Sie uns eine E-Mail an `info@zahedalfak.ir`.
...
**⭐ Wenn Ihnen dieses Projekt nützlich war, geben Sie bitte einen Stern! ⭐**
...
[API-Sicherheits-Checkliste auf GitHub](https://github.com/MrAlfak/API-Security-Checklist)

</div>

---

## 📋 Übersetzungs-TODO-Liste

Dieser Abschnitt verfolgt den Fortschritt der Übersetzung der API-Sicherheits-Checkliste in verschiedene Sprachen.

### ✅ Abgeschlossene Übersetzungen
- [x] 🇮🇷 Persisch (فارسی) - `Readme.md`
- [x] 🇬🇧 Englisch - `README.en.md`
- [x] 🇸🇦 Arabisch (العربية) - `README.ar.md`
- [x] 🇪🇸 Spanisch - `README.es.md`
- [x] 🇫🇷 Französisch - `README.fr.md`
- [x] 🇩🇪 Deutsch - `README.de.md`
